...
EOF
  ...
  dynamic!(:elb, 'controller',
           :listeners => [
             { :instance_port => '8080', :instance_protocol => 'tcp', :load_balancer_port => '443', :protocol => 'ssl', :ssl_certificate_id => registry!(:my_acm_server_certificate), :policy_names => [ref!(:elb_security_policy)] }
           ],
           :policies => [],
